...
public class StatsEmbedBuilder {
    ...
    private void setupStatsEmbed() {
        ...
        // HashSet<Player>(Bukkit.getServer().getOnlinePlayers());
         ...
         */
        // statsEmbed.setFooter("Text",
        // "https://github.com/zekroTJA/DiscordBot/blob/master/.wstatsEmbedsrc/zekroBot_Logo_-_round_small.png");
